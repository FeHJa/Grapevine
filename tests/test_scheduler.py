...
from custom_components.ha_mqtt_bridge.const import CONF_ENTITIES, CONF_TIME_PATTERN_MINUTES
from custom_components.ha_mqtt_bridge.protocol import ProtocolAdapter
